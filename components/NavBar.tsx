...
function NavBar() {
  ...
  <nav className='flex justify-between items-center h-28 pl-16 pr-14 space-x-6'>
    <Link href={'/'}><Image src={bodebar} height={64}  className='h-16'/></Link>
    <SearchForm/>
    <div className='flex'>
      <ul className='flex px-4 text-[#7B7B7B] text-xl'>
        <li className='px-2' ><Link href={'/products'}>PRODUCTOS</Link></li>
        <li className='px-2' ><Link href={'#'}>MONEDAS</Link></li>
      </ul>
